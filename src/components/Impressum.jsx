...
export default function Impressum() {
  return (
    <LegalPage title="Impressum">
      ...
      <p>Imkerei-Olthoff – Betreiber dieser Website:</p>

      <div className="legal__cards">
        <address className="legal__card">
          <strong>Bajo Olthoff</strong>
          Föhrstraße 40<br />
          26725 Emden
          <span className="legal__card-tel">Telefon: 0179 1223973</span>
        </address>
        <address className="legal__card">
          <strong>Oliver Olthoff</strong>
          Möhlenhörn 15<br />
          26736 Pewsum
          <span className="legal__card-tel">Telefon: 0151 54759546</span>
        </address>
      </div>

      <h2>Kontakt</h2>
      <p>
        Telefon: 0179 1223973 (Bajo Olthoff)<br />
        Telefon: 0151 54759546 (Oliver Olthoff)<br />
        E-Mail: info@imkerei-olthoff.de
      </p>

      <h2>Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h2>
      <p>
        Bajo Olthoff, Föhrstraße 40, 26725 Emden<br />
        Oliver Olthoff, Möhlenhörn 15, 26736 Pewsum
      </p>
